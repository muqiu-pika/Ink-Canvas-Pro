...
namespace Ink_Canvas
{
    public partial class MainWindow : Window
    {
        ...
        public static void SetSettingsToRecommendation()
        {
            ...
            Settings.InkToShape.IsLineRecognitionEnabled = true;
        ...
        private void ToggleSwitchEnableLineRecognition_Toggled(object sender, RoutedEventArgs e)
        {
            if (!isLoaded) return;
            Settings.InkToShape.IsLineRecognitionEnabled = ToggleSwitchEnableLineRecognition.IsOn;
            SaveSettingsToFile();
        }
